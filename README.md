...
## Что умеет
- **Автосплит списка.** Список больше 300 записей автоматически раскладывается по нескольким спискам
  `имя_1`, `имя_2`, `имя_3`, маршрут новому списку копируется с исходного.
